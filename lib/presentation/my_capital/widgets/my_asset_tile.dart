  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(stockName, style: JusicoolTypography.subTitle),
                Text(
                  stockPrice,
                  style: JusicoolTypography.label.copyWith(color: JusicoolColor.black),
                ),
              ],
            ),
          ],
        ...
        // 오른쪽 변동률
        Text(percentage, style: JusicoolTypography.subTitle),
      ],
    );
  }
}
