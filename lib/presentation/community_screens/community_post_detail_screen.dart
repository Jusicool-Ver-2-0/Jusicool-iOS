...
class _CommunityPostDetailScreenState extends State<CommunityPostDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('마이크로소프트 커뮤니티', style: JusicoolTypography.subTitle),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(_title, style: JusicoolTypography.titleSmall),
            const SizedBox(height: 16),
            Text(_content, style: JusicoolTypography.bodySmall),
            const SizedBox(height: 16),
