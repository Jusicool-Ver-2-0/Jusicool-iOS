  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('글 작성', style: JusicoolTypography.subTitle),
        centerTitle: true,
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: '제목을 입력하세요',
                    hintStyle: JusicoolTypography.titleSmall.copyWith(
                      color: JusicoolColor.gray200,
                    ),
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: '내용을 입력하세요',
                      hintStyle: JusicoolTypography.bodyMedium.copyWith(
                        color: JusicoolColor.gray200,
                      ),
                      border: InputBorder.none,
                    ),
